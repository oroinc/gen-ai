 ...
 */
class UserContentGenerationRequest
{
    public function __construct(
        private readonly string $submittedFormName,
        private readonly array $submittedFormData,
        private readonly string $submittedFormField,
        private readonly array $submittedContentGenerationFormData,
    ) {
    }
