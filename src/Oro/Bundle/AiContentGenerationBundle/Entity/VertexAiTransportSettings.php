...
class VertexAiTransportSettings extends Transport
{
    ...
    public const CONFIG_FILE = 'config_file';
     ...
     * )
     * @ORM\JoinTable(
     *      name="oro_vertex_ai_transp_label",
     *      joinColumns={
    ...
    /**
     * @ORM\Column(name="vertex_ai_config_file", type="crypted_text", nullable=true)
     */
    protected ?string $configFile = null;

    /**
     * @ORM\Column(name="vertex_ai_api_endpoint", type="string", length=255, nullable=true)
     */
    protected ?string $apiEndpoint = null;

    /**
     * @ORM\Column(name="vertex_ai_project_id", type="string", length=255, nullable=true)
     */
    protected ?string $projectId = null;

    /**
     * @ORM\Column(name="vertex_ai_location", type="string", length=255, nullable=true)
     */
    protected string $location = self::DEFAULT_LOCATION;

    /**
     * @ORM\Column(name="vertex_ai_model", type="string", length=255, nullable=true)
     */
